...
export type DemoAccount = { role: string; username?: string; password?: string; disabled?: boolean; note?: string }
...
// 데모 빠른 로그인 — 계정 목록은 서버 페이지가 실제 사용자에서 뽑아 넘긴다.
export default function LoginForm({ demoAccounts }: { demoAccounts: DemoAccount[] }) {
