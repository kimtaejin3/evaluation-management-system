            ...
            {ranked.map((r) => (
              ...
              >
                <td className="px-5 py-3">
                  <span
                    className={`inline-flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold 'bg-slate-100 text-slate-600'
                  `}
                  >
                    {r.rank}
                  </span>
                ...
                <td className="px-5 py-3 text-right text-lg font-bold text-slate-900">
