...
describe('canManageSession', () => {
  ...
  it('담당자 userId가 빈 문자열이고 분과도 빈 문자열이면 오탐 방지(!! 로 걸러짐)', () => {
