// 과제(Project) 하위 페이지 정의 — 관리자 사이드바(AdminSidebar)의 단일 출처.
// 관리자는 분과 단위가 아니라 과제 단위로 아래 페이지들에서 분과들을 테이블 뷰로 한눈에 본다.
export const PROJECT_TABS = [
  { suffix: "", label: "분과 관리", desc: "분과 추가·간사 배정" },
  { suffix: "/monitoring", label: "실시간 모니터링", desc: "분과별 채점 진행 현황" },
  { suffix: "/criteria", label: "평가항목", desc: "과제 공통 항목 작성·간사 확인 현황" },
